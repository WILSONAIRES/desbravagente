...
const HomeBackground = ({ imagePath }: { imagePath: string }) => {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden bg-gradient-to-br from-slate-200 to-slate-300">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
...
export default function Home() {
  return (
    <div className="bg-transparent! min-h-screen">
      <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-4 overflow-hidden bg-transparent">
